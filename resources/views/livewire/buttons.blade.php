                        ...
                        <table class="table align-items-center mb-0" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="mx-1" data-bs-toggle="modal" data-bs-target="#updateButtonsModal" wire:click="editButton({{$button->id}})">
                                        ...
                                        <span>
                                            <button type="button" class="mx-1" data-bs-toggle="modal" data-bs-target="#deleteButtonsModal" wire:click="deleteButton({{$button->id}})">
