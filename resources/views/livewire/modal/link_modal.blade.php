                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" wire:model="_group">
                                    <option value="customer_service" selected>{{__('translate.customer_service')}}</option>
                                    <option value="redirect">{{__('translate.redirect')}}</option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" wire:model="_group">
                                    <option value="customer_service">{{__('translate.customer_service')}}</option>
                                    <option value="redirect">{{__('translate.redirect')}}</option>
                                </select>
                                @error('_group') <span class="text-danger">{{ __('translate.error_group') }}</span> @enderror
                            </div>
