<!-- Modal -->
<div wire:ignore.self class="modal fade" id="addnewUsersModal" tabindex="-1" aria-labelledby="addnewUsersModalLabel"
        ...
        <div class="modal-content" style="width: 100% !important;">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" wire:click="closeModal"
                    aria-label="Close"><i class="fas fa-close text-secondary text-sm"></i></button>
            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            @error('email')
                                <span class="text-danger">{{ __('translate.error_email') }}</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            @error('password')
                                <span class="text-danger">{{ __('translate.error_password') }}</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            @error('role')
                                <span class="text-danger">{{ __('translate.error_role') }}</span>
                            @enderror
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn bg-gradient-success"><i class="fas fa-save"
                            aria-hidden="true"></i> &nbsp; {{ __('translate.save') }}</button>
                </div>
            </form>
...
<!-- Update Links Modal -->
<div wire:ignore.self class="modal fade" id="updateUsersModal" tabindex="-1" aria-labelledby="updateUsersModalLabel"
    aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form wire:submit.prevent="resetPassword" action="#" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="name" class="form-control">
                                @error('name')
                                    <span id="text-danger" class="text-danger">{{ __('translate.error_name') }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label>{{ __('translate.email') }}</label>
                                ...
                                @error('email')
                                    <span id="text-danger" class="text-danger">{{ __('translate.error_email') }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label for="role">{{ __('translate.role') }}</label>
                                <select class="custom-select custom-select-lg mb-3 w-100" wire:model="role"
                                    id="role">
                                    <option value="">Select One</option>
                                    <option value="1">Super admin</option>
                                    <option value="2">Admin</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @error('password')
                                    <span id="text-danger"
                                        class="text-danger">{{ __('translate.error_password') }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                @error('passwordConfirmation')
                                    <span id="text-danger"
                                        class="text-danger">{{ __('translate.error_confirmpassword') }}</span>
                                @enderror
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn bg-gradient-info"><i class="fas fa-edit"
                            aria-hidden="true"></i>&nbsp; {{ __('translate.update') }}</button>
                </div>
            </form>
...
<!-- Delete User Modal -->
<div wire:ignore.self class="modal fade" id="deleteUsersModal" tabindex="-1"
    aria-labelledby="deleteUsersModalLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <form wire:submit.prevent="destroyUser">
                        @if ($usersDetails)
                            ...
                            <ul class="mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <li class="border-0 ps-0 pt-0 text-sm"><strong
                                                class="text-dark">{{ __('translate.name') }}:
                                            </strong> &nbsp; {{ $usersDetails->name }}</li>
                                        <li class="border-0 ps-0 text-sm"><strong
                                                class="text-dark">{{ __('translate.email') }}:</strong>
                                            &nbsp; {{ $usersDetails->email }}</li>
                                        <li class="border-0 ps-0 text-sm"><strong
                                                class="text-dark">{{ __('translate.role') }}:</strong>
                            ...
                            <div class="modal-footer align-items-center">
                                ...
                                <button class="btn bg-gradient-danger btn-md" type="submit"><i
                                        class="cursor-pointer fas fa-trash mr-3" aria-hidden="true"></i>
                                    {{ __('translate.delete') }}</button>
                            </div>
                        @endif
                    </form>
                </div>
