...
use App\Http\Livewire\SlugManagement;
...
Route::get('/sl/{slug}', 'App\Http\Controllers\LandingPageController@slug')->name('slug');
...
Route::middleware('auth')->group(function () {
    ...
    // slug
    Route::get('/GdascasdgsX', SlugManagement::class)->name('slug-management');
